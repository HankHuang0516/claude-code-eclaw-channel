...
# tmux kill-session already sends SIGHUP to all child processes.
# Do NOT pgrep for fakechat — that would kill VS Code / other Claude sessions too.
...
# Wait for fakechat to come back online
...
while [ $WAITED -lt $MAX_WAIT ]; do
  ...
  if check_fakechat; then
    log "fakechat is back online after ${WAITED}s"
